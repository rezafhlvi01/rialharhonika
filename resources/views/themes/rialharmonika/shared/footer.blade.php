<footer>
  <div class="container pt-5">
    <div class="row row-content">
      <div class="col-md-6">
        <h1 class="logo-brand">Rial- <span>Harmonika</span></h1>
      ...
      <div class="col-md-3 mt-4 mt-sm-0">
        ...
        <a href="#">rialharmonika@gmail.com</a>
        <p>Jln. Guntung Payung, Blok F, No 20 Landasan Ulin Kalimantan Selatan</p>
      </div>
    </div>
    <div class="row row-copy mt-4 mt-sm-0">
      <div class="col-md-6">
        <p>&copy; 2024 Rial-Harmonika. All rights reserved.</p>
      </div>
